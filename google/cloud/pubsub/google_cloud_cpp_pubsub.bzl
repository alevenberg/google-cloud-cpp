...
google_cloud_cpp_pubsub_hdrs = [
    ...
    "internal/subscription_concurrency_control_source.h",
    ...
    "internal/tracing_ack_handler.h",
    ...
    "internal/tracing_subscription_message_queue.h",
    "message.h",
    "options.h",
    "publisher.h",
...
google_cloud_cpp_pubsub_srcs = [
    ...
    "internal/tracing_ack_handler.cc",
