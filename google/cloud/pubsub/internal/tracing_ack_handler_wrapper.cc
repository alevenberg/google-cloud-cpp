...
#include "google/cloud/pubsub/internal/tracing_ack_handler_wrapper.h"
...
void TracingAckHandlerWrapper::ack() {
  auto span = internal::MakeSpan("settle");
...
void TracingAckHandlerWrapper::nack() {
...
std::int32_t TracingAckHandlerWrapper::delivery_attempt() const {
